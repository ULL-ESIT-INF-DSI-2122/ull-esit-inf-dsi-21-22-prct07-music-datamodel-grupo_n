...
export let Soldadito_marinero = new Song('Soldadito marinero', Fito_y_Fitipaldis, 215.4 ,[Rock_Esp], true, 57833321);
...
export let Just_the_way_you_are = new Song('Just the way you are', Bruno_Mars, 213.6, [Pop], true, 1704676116);
...
export let Ojala_que_llueva_cafe = new Song('Ojala que llueva que cafe', Juan_Luis_war, 247.8, [Bachata], false, 1481024);
...
Bejo.addAlbum(Que_Dice_la_Juventud);
